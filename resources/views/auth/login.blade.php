...
<div class="min-h-screen bg-[#FDFBF7] flex items-center justify-center py-24 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full bg-white p-10 border border-gray-100 shadow-[0_10px_40px_rgba(0,0,0,0.04)]">
        ...
        <div class="text-center mb-10">
            <h2 class="font-script text-5xl text-gray-900 mb-2">Welcome Back</h2>
            <p class="text-[10px] font-sans-custom font-bold tracking-[0.3em] uppercase text-gray-400">Sign in to your account</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <div class="flex items-center justify-between mt-6">
                <label class="flex items-center text-xs text-gray-500 hover:text-black cursor-pointer">
                    <input type="checkbox" name="remember" class="mr-2 accent-black cursor-pointer"> Remember me
                </label>
                <a href="{{ route('password.request') }}" class="text-[10px] uppercase tracking-widest font-bold text-gray-400 hover:text-black transition-colors">Forgot Password?</a>
            </div>
        ...
        <div class="mt-8 mb-6 flex items-center">
            ...
            <span class="px-4 text-[9px] font-bold tracking-widest uppercase text-gray-400">Or continue with</span>
            <div class="flex-grow h-px bg-gray-200"></div>
        </div>
        ...
        <div class="mt-10 text-center">
            <p class="text-xs text-gray-500 font-serif-custom italic">Don't have an account? 
                <a href="{{ route('register') }}" class="font-sans-custom font-bold text-[10px] tracking-widest uppercase text-black ml-1 border-b border-black pb-1 hover:text-gray-600">Create One</a>
            </p>
        </div>
    </div>
</div>
